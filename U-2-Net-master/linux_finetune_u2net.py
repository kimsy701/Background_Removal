# -*- coding: utf-8 -*-
"""linux_finetune_u2net.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tebpLCgs1EjgMRfft9F_VUhLb2cLF_qE

참고: https://github.com/danielgatis/rembg/issues/193#issuecomment-1055534289
"""

import os
#os.chdir("./U-2-Net-master")
...
salobj_dataset = SalObjDataset(
    ...
    transform=transforms.Compose([
        ...
        RandomCrop(288),
        ToTensorLab(flag=0)]))
#salobj_dataloader = DataLoader(salobj_dataset,ex batch_size=batch_size_train, shuffle=True, num_workers=1)
